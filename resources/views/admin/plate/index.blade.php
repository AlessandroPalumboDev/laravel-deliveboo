                    ...
                    <div class="card mb-4 shadow-lg border-primary rounded">
                        ...
                        <div class="card-body d-flex g-0">
                            ...
                            <div class="card-img my-3">
                                <img src="{{ asset('storage/' . $plate->cover_image) }}" class="img-fluid rounded-start" style="max-height: 200px;">
                            </div> 
                            ...
                            <div class="col-md-8 my-3 ms-3">
                                ...
                                <div class="d-flex gap-3">
                                    <a href="{{ route('admin.plates.edit', $plate->id) }}" class="btn btn-outline-primary">Modifica</a>
                        ...
                        <div class="card-footer bg-primary d-flex justify-content-between">
                            <a href="{{ route('admin.plates.show', $plate->id) }}" class="btn btn-outline-light">Dettagli</a>

                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $plate->id }}">
                                Elimina
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content border-danger">
                                <div class="modal-header border-danger">
                                    <h1 class="modal-title fs-5 text-danger" id="deleteModalLabel{{ $plate->id }}">Elimina Piatto</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <p>Sei sicuro di voler eliminare il piatto <strong>{{ $plate->name }}</strong>? Questa azione sarà irreversibile!</p>
                                </div>
