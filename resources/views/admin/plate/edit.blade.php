                    ...
                    <form action="{{ route('admin.plates.update', $plate->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control border-primary" id="ingredients" name="ingredients"
                            ...
                            <div class="d-flex gap-4 mb-3 flex-wrap">
                                <div class="mb-3 form-check">
                                    <input class="form-check-input border-primary" type="checkbox" name="is_vegetarian" id="is_vegetarian"
                                        value="1" {{ old('is_vegetarian', $plate->is_vegetarian) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3 form-check">
                                    <input class="form-check-input border-primary" type="checkbox" name="is_vegan" value="1"
                                        {{ old('is_vegan', $plate->is_vegan) ? 'checked' : '' }} id="is_vegan">
                                ...
                                <div class="mb-3 form-check">
                                    <input class="form-check-input border-primary" type="checkbox" name="is_gluten_free" value="1"
                                        {{ old('is_gluten_free', $plate->is_gluten_free) ? 'checked' : '' }} id="is_gluten_free">
                                ...
                                <div class="mb-3 form-check">
                                    <input class="form-check-input border-primary" type="checkbox" name="is_lactose_free" value="1"
                                        {{ old('is_lactose_free', $plate->is_lactose_free) ? 'checked' : '' }} id="is_lactose_free">
                                ...
                                <div class="mb-3 form-check">
                                    <input class="form-check-input border-primary" type="checkbox" name="is_spicy" value="1"
                                        {{ old('is_spicy', $plate->is_spicy) ? 'checked' : '' }} id="is_spicy">
                            ...
                            <div class="mb-3 form-check">
                                <input class="form-check-input border-primary" type="checkbox" name="is_visible" value="1"
                                    {{ old('is_visible', $plate->is_visible) ? 'checked' : '' }} id="is_visible">
                            ...
                            <div class="mb-3">
                                ...
                                <img src="{{ asset('storage/' . $plate->cover_image) }}" alt="Piatto" class="img-fluid mt-3" style="max-height: 200px;">
                            </div>
                        </div>
